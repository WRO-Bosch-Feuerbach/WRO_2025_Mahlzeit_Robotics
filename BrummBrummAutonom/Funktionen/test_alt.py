...
def fahren():
  ...
  try:
    ...
    while True:
      ...
      distanceLinks = Ultraschallsensor.checkdistLinks()
      distanceRechts = Ultraschallsensor.checkdistRechts()
      ServoLenkung.set_angle(1,90)                                    # Servo gerade stellen
   ...
   '''
    while FahrenLinks == True:
      ...
      winkel_gerundet = round(winkel) + 20                      # Rundet winkel hoch
    ...
    while FahrenRechts == True:
      ...
      print(winkel_gerundet)                # Winkel wird gerundet
      ...
      if distanceRechts < 30:                                  #
        ServoLenkung.set_angle(1,180)                                 # Lenkt links wenn rechts die Entfernung zu klein wird
